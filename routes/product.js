...
import { addProduct, deleteProduct, getAllProducts, getAllProductsForFarmer, getMyProduct, updateProduct, getProductDetails } from "../controllers/products.js";
...
router.get("/:productId/details", isAuthenticated, getProductDetails);
